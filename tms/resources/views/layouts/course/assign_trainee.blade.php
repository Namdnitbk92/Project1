        ...
        <div class="modal-content" >
            <div class="modal-header panel-heading">
                <h4 class="modal-title ">
                    Assign Trainee To Course <i class="pointing right icon"></i> <course class="ui label tag red"></course></label>
                    <button class="ui circular google plus icon button">
                        <value class="total-trainee"> 0 </value>
                    </button>
                </h4>
            </div>
            <div class="modal-body">
                <div class="ui active centered inline loader loading-ajax" style="display:none;"></div>
                <div class="ui green message result-assign" style="display:none;"><result-assign></result-assign></div>
                            ...
                            <div class="item">
                                <div class="right floated content">
                                    <div class="ui buttons">
                                        <button class="ui button active red" onclick="removeCourse('{{ $trainee->id }}')">
                                ...
                                <img class="ui avatar image" src="{{ empty($trainee->avatar) ? asset('images/trainee.png') : $trainee->avatar}}">
                                <div class="content">
...
<script>
    ...
    function addCourse(userId) {
        ...
        $('.total-trainee').text(joins.length);
    }
