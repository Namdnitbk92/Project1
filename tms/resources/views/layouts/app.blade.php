...
<head>
    ...
    <meta property="og:title" content="TMS System"/>
    <meta property="og:description" content="This is a website about course,subject,task list for trainee joined website"/>
                ...
                @else
                    ...
                    <!-- <mail>{{ Auth::user()->email}}</mail> -->
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="{{ url('/logout') }}"><i class="fa fa-btn fa-sign-out fa-fw"></i>Logout</a>
                            </li>
                            <li><a href="{{ url('/profile') }}"><i class="fa fa-btn fa-user fa-fw"></i>Profile</a></li>
                            <li><a href="{{ url('/profile') }}"><i class="fa fa-btn fa-bolt fa-fw"></i>Languages</a>
                            </li>
                        </ul>
                    </li>
                @endif
